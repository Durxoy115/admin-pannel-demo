       ...
       <div>
             <div className="mt-4 sm:mt-6 md:mt-8">
               <div className="flex flex-col sm:flex-row sm:items-center justify-between   mb-4 sm:mb-6">
                 <h1 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-0">Company Officials & Signatures</h1>
                 <button
                 ...
                 <table className="min-w-full bg-white border border-gray-300 rounded-md shadow-md ">
                   <thead>
                     <tr className="bg-gray-100">
                       <th className="py-2 sm:py-3 px-4 sm:px-6 text-left border-b text-xs sm:text-sm">Title</th>
                       <th className="py-2 sm:py-3 px-4 sm:px-6 text-left border-b text-xs sm:text-sm">Signature</th>
                    
                       <th className="py-2 sm:py-3 px-4 sm:px-6 text-right border-b text-xs sm:text-sm">Actions</th>
                   ...
                   <tbody>
                     {signature.map((sign) => (
                       <tr key={sign.id} className="hover:bg-gray-50">
                         <td className="py-2 sm:py-3 px-4 sm:px-6 border-b text-xs  sm:text-sm">{sign.title}</td>
