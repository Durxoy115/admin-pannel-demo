  ...
  useEffect(() => {
    const fetchAddress = async () => {
      try {
        ...
        setGlobalError(
          "Error fetching billing addresses: " + error?.data.message
        );
      }
    };
    fetchAddress();
    ...
    const fetchAddress = async () => {
      try {
        ...
        if (data.success) {
          ...
          setGlobalError(
            "Error fetching company addresses: " + data?.data?.message
          );
        }
      } catch (error) {
        setGlobalError(
          "Error fetching company addresses: " + error?.daya?.message
        );
      }
    };
    fetchAddress();
